...
print("Prediction:\nGood reviews: {}\nBad reviews: {}\n".format(sum(Y_pred),len(Y_pred)-sum(Y_pred)))
print("F1 score for each label: ")
print("Bad: {:.3},  Good: {:.3}".format(f1_score(new_Y_2, Y_pred, average=None)[0], f1_score(new_Y_2, Y_pred, average=None)[1]))
...
print("\nPrediction:\nGood reviews: {}\nBad reviews: {}\n".format(sum(Y_pred),len(Y_pred)-sum(Y_pred)))
print("F1 score for each label: ")
print("Bad: {:.3},  Good: {:.3}".format(f1_score(Y_test, Y_pred, average=None)[0], f1_score(Y_test, Y_pred, average=None)[1]))
